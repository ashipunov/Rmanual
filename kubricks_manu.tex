\documentclass[12pt]{report} % change if you want, e.g., smaller fonts; "report" is like "book" but simpler
\usepackage{%
graphicx, % use images
hyperref, % use links and hyperlinks
geometry, % change page size and margins
...
% Define sections and section-like
\newcommand{\FF}[1]{\section{#1}}
\renewcommand{\thesection}{\arabic{section}} % there are no chapters so section numbered independently

% Define species names
\newcommand{\KK}[1]{\textit{#1}}
\newcommand{\SP}[1]{{\bigskip\noindent\textbf{#1}\par\nopagebreak[4]\medskip}}

% Define species descriptions
...
\sloppy % useful because it is hard to control formatting of the "0body" manually
...
\input 0body % insert the "table" outputted from R
